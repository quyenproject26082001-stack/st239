...
import com.ponymaker.avatarcreator.maker.ui.cosplay.CosplayRandomActivity
import com.ponymaker.avatarcreator.maker.ui.trending.TrendingActivity
...
class HomeActivity : BaseActivity<ActivityHomeBinding>() {
    ...
    override fun viewListener() {
        binding.apply {
            ...
            btnPlay.tap(800) { startIntentRightToLeft(com.ponymaker.avatarcreator.maker.ui.choose_character.ChooseCharacterActivity::class.java) }
