package com.ponymaker.avatarcreator.maker.ui.customize
...
import com.ponymaker.avatarcreator.maker.core.helper.BitmapHelper
import com.ponymaker.avatarcreator.maker.core.helper.InternetHelper
import com.ponymaker.avatarcreator.maker.core.helper.MediaHelper
import com.ponymaker.avatarcreator.maker.core.utils.key.AssetsKey
...
import com.ponymaker.avatarcreator.maker.data.model.custom.ItemColorImageModel
import com.ponymaker.avatarcreator.maker.data.model.custom.ItemColorModel
import com.ponymaker.avatarcreator.maker.data.model.custom.ItemNavCustomModel
import com.ponymaker.avatarcreator.maker.data.model.custom.LayerListModel
import com.ponymaker.avatarcreator.maker.data.model.custom.NavigationModel
import com.ponymaker.avatarcreator.maker.data.model.custom.SuggestionModel
...
class CustomizeCharacterViewModel : ViewModel() {
    ...
    suspend fun setBottomNavigationListDefault(targetLayerIndex: Int = -1) {
        ...
        if (itemNavList.size > firstLayerIndex) {
            ...
            val hasNone = firstNavItems.firstOrNull()?.path == com.ponymaker.avatarcreator.maker.core.utils.key.AssetsKey.NONE_LAYER
            val hasRandom = firstNavItems.firstOrNull()?.path == com.ponymaker.avatarcreator.maker.core.utils.key.AssetsKey.RANDOM_LAYER
    ...
    fun checkDataInternet(context: Activity, action: (() -> Unit)) {
        ...
        InternetHelper.checkInternet(context) { result ->
            if (result == HandleState.SUCCESS) {
                ...
                val dialog = com.ponymaker.avatarcreator.maker.dialog.YesNoDialog(
                    context,
