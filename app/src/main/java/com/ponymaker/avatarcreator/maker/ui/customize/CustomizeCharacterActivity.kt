...
import com.ponymaker.avatarcreator.maker.core.extensions.dLog
import com.ponymaker.avatarcreator.maker.core.extensions.eLog
...
import com.ponymaker.avatarcreator.maker.core.extensions.logEvent
...
import com.ponymaker.avatarcreator.maker.core.extensions.startIntentLeftToRight
...
import com.ponymaker.avatarcreator.maker.ui.add_character.AddCharacterActivity
                ...
                if (deferred1.await() && deferred2.await() && deferred3.await()) {
                    ...
                    if (viewModel.colorItemNavList[viewModel.positionNavSelected].size > 1) {
                        binding.rcvColor.post {
                            binding.rcvColor.scrollToPosition(
                                viewModel.colorItemNavList[viewModel.positionNavSelected].indexOfFirst { it.isSelected }.coerceAtLeast(0)
                            )
                        }
                    }
                    checkStatusColor()
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            if (currentPath.isNullOrEmpty()) {
                val selectedItem = listToSubmit.firstOrNull {
                    it.isSelected &&
                    it.path != com.ponymaker.avatarcreator.maker.core.utils.key.AssetsKey.NONE_LAYER &&
                    it.path != com.ponymaker.avatarcreator.maker.core.utils.key.AssetsKey.RANDOM_LAYER
                }
