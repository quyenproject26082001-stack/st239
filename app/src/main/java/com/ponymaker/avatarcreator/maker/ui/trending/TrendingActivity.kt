package com.ponymaker.avatarcreator.maker.ui.trending
...
import com.ponymaker.avatarcreator.maker.databinding.ActivityTrendingBinding
import com.ponymaker.avatarcreator.maker.dialog.YesNoDialog
import com.ponymaker.avatarcreator.maker.ui.customize.CustomizeCharacterActivity
import com.ponymaker.avatarcreator.maker.ui.customize.CustomizeCharacterViewModel
import com.ponymaker.avatarcreator.maker.ui.home.DataViewModel
import com.ponymaker.avatarcreator.maker.ui.random_character.RandomCharacterViewModel
...
class TrendingActivity : BaseActivity<ActivityTrendingBinding>() {
    ...
    private fun initData() {
        ...
        CoroutineScope(SupervisorJob() + Dispatchers.Main + handleExceptionCoroutine).launch {
            ...
            suspend fun processCharacter(data: com.ponymaker.avatarcreator.maker.data.model.custom.CustomizeModel) {
                ...
                val allNavList = data.layerList.mapIndexed { index, layer ->
                    com.ponymaker.avatarcreator.maker.data.model.custom.NavigationModel(
