...
import com.ponymaker.avatarcreator.maker.ui.random_character.RandomCharacterActivity
...
import com.ponymaker.avatarcreator.maker.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.ponymaker.avatarcreator.maker.data.model.custom.CustomizeModel>) {
